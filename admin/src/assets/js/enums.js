...
TRAIN_TYPE={G:{code:"G",desc:"G-series",priceRate:"1.2"},D:{code:"D",desc:"D-series",priceRate:"1"},K:{code:"K",desc:"K-series",priceRate:"0.8"}};
SEAT_TYPE={YDZ:{code:"1",desc:"First class",price:"0.4"},EDZ:{code:"2",desc:"Second class",price:"0.3"},RW:{code:"3",desc:"Soft Sleeper",price:"0.6"},YW:{code:"4",desc:"Hard Sleeper",price:"0.5"}};
...
CONFIRM_ORDER_STATUS={INIT:{code:"I",desc:"Initiating"},PENDING:{code:"P",desc:"Pending"},SUCCESS:{code:"S",desc:"Succeeded"},FAILURE:{code:"F",desc:"Failed"},EMPTY:{code:"E",desc:"Out of stock"},CANCEL:{code:"C",desc:"Cancel"}};

PASSENGER_TYPE_ARRAY=[{code:"1",desc:"Adult"},{code:"2",desc:"Child"},{code:"3",desc:"Student"}];
TRAIN_TYPE_ARRAY=[{code:"G",desc:"G-series",priceRate:"1.2"},{code:"D",desc:"D-series",priceRate:"1"},{code:"K",desc:"K-series",priceRate:"0.8"}];
...
CONFIRM_ORDER_STATUS_ARRAY=[{code:"I",desc:"Initiating"},{code:"P",desc:"Pending"},{code:"S",desc:"Succeeded"},{code:"F",desc:"Failed"},{code:"E",desc:"Out of stock"},{code:"C",desc:"Cancel"}];
